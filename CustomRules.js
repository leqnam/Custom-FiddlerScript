...
class Handlers {
    ...
    public static ToolsAction("Crawl Sequential URLs", "NREADY.NET")
    ...
    public static ToolsAction("Replay Sequential URLs", "NREADY.NET")
    ...
    function CopyTimers(oSessions: Fiddler.Session[]) {
        ...
        FiddlerObject.StatusText = "Coppied xong...";
    }

    public static ContextAction("Sequences DELETE")
    ...
    function Seq_DELETE(arrSess: Session[]) {
        ...
        MessageBox.Show("Chay xong...");
        FiddlerObject.StatusText = "Chay xong...";
    }
    ...
    */
    ...
    public static RulesOption("&Show Time-to-Last-Byte", "NREADY.NET")
    var m_ShowTTLB: boolean = true;

    // Show the time of response completion
    public static RulesOption("Show Response &Timestamp", "NREADY.NET")
    var m_ShowTimestamp: boolean = true;

    // Show the time of response completion
    public static RulesOption("Apply Custom &Filter", "NREADY.NET")
    ...
    function OnBeforeRequest(oSession: Session) {
        ...
        if (m_filterOn) {
            ...
            var host = ["localhost", "intrack.gvivn.global", "test-www.cortexanswers.com", "www-dev.cortexgo.com"];
        ...
        if (m_SimulateModem) {
            // Delay sends by 400ms per KB uploaded.
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        /*if (m_ShowTimestamp) {
            oSession["ui-customcolumn"] = DateTime.Now.ToString("HH:mm:ss.ffff") + " " + oSession["ui-customcolumn"];
        }*/

        // Simulate web service slowdown
        if (m_SimulateModem) {
            //if (oSession.HostnameIs("localhost")){
            oSession["response-trickle-delay"] = "600";
            //}
        }
